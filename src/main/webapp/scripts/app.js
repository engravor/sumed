...
var sumedApp = angular.module('sumedApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'sumedAppUtils', 'pascalprecht.translate', 'truncate', 'ngCacheBuster']);
